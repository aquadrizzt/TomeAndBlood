...
IF ~~ level_one 
	SAY ~Here is a list of available Level One spells that you do not know.~ 
		...
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI117")~ +~Chill Touch~   + Chill_Touch 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI118")~ +~Chromatic Orb~   + Chromatic_Orb 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI105")~ +~Color Spray~   + Color_Spray
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI126")~ +~Expeditious Retreat~   + Expeditious_Retreat 
		...
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI120")~ +~Reflected Image~   + Reflected_Image 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI114")~ +~Shield~   + Shield 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI115")~ +~Shocking Grasp~   + Shocking_Grasp 
...
IF ~~ level_two 
	SAY ~Here is a list of available Level Two spells that you do not know.~ 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI217")~ +~Aganazzar's Scorcher~   + Aganazzars_Scorcher 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI226")~ +~Blindness~   + Blindness 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI201")~ +~Blur~   + Blur 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI225")~ +~Cat's Grace~   + Cats_Grace 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI223")~ +~Deafness~   + Deafness 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI216")~ +~Decastave~   + Decastave 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI202")~ +~Detect Evil~   + Detect_Evil 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI203")~ +~Detect Invisbility~   + Detect_Invisibility 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI218")~ +~Ghoul Touch~   + Ghoul_Touch 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI224")~ +~Glitterdust~   + Glitterdust 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI205")~ +~Horror~   + Horror 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI206")~ +~Invisibility~   + Invisibility 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI207")~ +~Knock~   + Knock 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI208")~ +~Know Alignment~   + Know_Alignment 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI209")~ +~Luck~   + Luck 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI211")~ +~Melf's Acid Arrow~   + Melfs_Acid_Arrow 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI212")~ +~Mirror Image~   + Mirror_Image 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI220")~ +~Power Word: Sleep~   + Power_Word_Sleep 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI227")~ +~Protection from Petrification~   + Protection_from_Petrification 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI221")~ +~Ray of Enfeeblement~   + Ray_of_Enfeeblement 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI210")~ +~Resist Fear~   + Resist_Fear 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI204")~ +~Snilloc's Snowball Swarm~   + Snillocs_Snowball_Swarm 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI213")~ +~Stinking Cloud~   + Stinking_Cloud 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI214")~ +~Strength~   + Strength 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI219")~ +~Vocalize~   + Vocalize 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI215")~ +~Web~   + Web 
		++ ~Main Menu~ + main_menu
		++ ~I want to leave.~ + End
END
...
IF ~~ level_three 
	SAY ~Here is a list of available Level Three spells that you do not know.~ 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI301")~ +~Clairvoyance~   + Clairvoyance 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI302")~ +~Remove Magic~   + Remove_Magic 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI303")~ +~Flame Arrow~   + Flame_Arrow 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI304")~ +~Fireball~   + Fireball 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI305")~ +~Haste~   + Haste 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI306")~ +~Hold Person~   + Hold_Person 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI307")~ +~Invisibility, 10 ft Radius~   + Invisibility_10_ft_Radius 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI308")~ +~Lightning Bolt~   + Lightning_Bolt 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI309")~ +~Monster Summoning I~   + Monster_Summoning_I 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI310")~ +~Non-detection~   + Nondetection 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI311")~ +~Protection from Normal Missiles~   + Protection_from_Normal_Missiles 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI312")~ +~Slow~   + Slow 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI313")~ +~Skull Trap~   + Skull_Trap 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI314")~ +~Vampiric Touch~   + Vampiric_Touch 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI315")~ +~Wraithform~   + Wraithform 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI316")~ +~Dire Charm~   + Dire_Charm 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI317")~ +~Ghost Armor~   + Ghost_Armor 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI318")~ +~Minor Spell Deflection~   + Minor_Spell_Deflection 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI319")~ +~Protection from Fire~   + Protection_from_Fire 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI320")~ +~Protection from Cold~   + Protection_from_Cold 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI321")~ +~Spell Thrust~   + Spell_Thrust 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI322")~ +~Detect Illusion~   + Detect_Illusion 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI323")~ +~Dispel Magic~   + Dispel_Magic 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI324")~ +~Hold Undead~   + Hold_Undead 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI325")~ +~Melf's Minute Meteors~   + Melfs_Minute_Meteors 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI327")~ +~Icelance~   + Icelance 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI328")~ +~Lance of Disruption~   + Lance_of_Disruption 
		++ ~Main Menu~ + main_menu
		++ ~I want to leave.~ + End
END
...
IF ~~ level_four 
	SAY ~Here is a list of available Level Four spells that you do not know.~ 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI401")~ +~Confusion~   + Confusion 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI402")~ +~Dimension Door~   + Dimension_Door 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI403")~ +~Fireshield (Blue)~   + Fireshield_Blue 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI404")~ +~Ice Storm~   + Ice_Storm 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI405")~ +~Improved Invisibility~   + Improved_Invisibility 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI406")~ +~Minor Globe of Invulnerability~   + Minor_Globe_of_Invulnerability 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI407")~ +~Monster Summoning II~   + Monster_Summoning_II 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI408")~ +~Stoneskin~   + Stoneskin 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI409")~ +~Contagion~   + Contagion 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI410")~ +~Remove Curse~   + Remove_Curse 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI411")~ +~Emotion: Hopelessness~   + Emotion_Hopelessness 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI412")~ +~Greater Malison~   + Greater_Malison 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI413")~ +~Otiluke's Resilient Sphere~   + Otilukes_Resilient_Sphere 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI414")~ +~Spirit Armor~   + Spirit_Armor 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI415")~ +~Polymorph Other~   + Polymorph_Other 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI416")~ +~Polymorph Self~   + Polymorph_Self 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI417")~ +~Enchanted Weapon~   + Enchanted_Weapon 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI418")~ +~Fireshield (Red)~   + Fireshield_Red 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI419")~ +~Secret Word~   + Secret_Word 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI420")~ +~Minor Sequencer~   + Minor_Sequencer 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI421")~ +~Teleport Field~   + Teleport_Field 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI422")~ +~Beltyn's Burning Blood~   + Beltyns_Burning_Blood 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI423")~ +~Spider Spawn~   + Spider_Spawn 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI424")~ +~Farsight~   + Farsight 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI425")~ +~Wizard Eye~   + Wizard_Eye 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI426")~ +~Shadow Monsters~   + Shadow_Monsters 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI427")~ +~Emotion: Courage~   + Emotion_Courage 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI428")~ +~Emotion: Fear~   + Emotion_Fear 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI429")~ +~Emotion: Hope~   + Emotion_Hope 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI430")~ +~Mordenkainen's Force Missiles~   + Mordenkainens_Force_Missiles 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI431")~ +~Shout~   + Shout 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI432")~ +~Vitriolic Sphere~   + Vitriolic_Sphere  
		++ ~Main Menu~ + main_menu
		++ ~I want to leave.~ + End
END
...
IF ~~ level_five 
	SAY ~Here is a list of available Level Five spells that you do not know.~ 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI501")~ +~Animate Dead~   + Animate_Dead 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI502")~ +~Cloudkill~   + Cloudkill 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI503")~ +~Cone of Cold~   + Cone_of_Cold 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI504")~ +~Monster Summoning III~   + Monster_Summoning_III 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI505")~ +~Shadow Door~   + Shadow_Door 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI506")~ +~Domination~   + Domination 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI507")~ +~Hold Monster~   + Hold_Monster 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI508")~ +~Chaos~   + Chaos 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI509")~ +~Feeblemind~   + Feeblemind 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI510")~ +~Spell Immunity~   + Spell_Immunity 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI511")~ +~Protection from Normal Weapons~   + Protection_from_Normal_Weapons 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI512")~ +~Protection from Electricity~   + Protection_from_Electricity 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI513")~ +~Breach~   + Breach 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI514")~ +~Lower Resistance~   + Lower_Resistance 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI515")~ +~Oracle~   + Oracle 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI531")~ +~Conjure Fire Elemental~   + Conjure_Fire_Elemental 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI517")~ +~Protection from Acid~   + Protection_from_Acid 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI518")~ +~Phantom Blade~   + Phantom_Blade 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI519")~ +~Spell Shield~   + Spell_Shield 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI534")~ +~Conjure Air Elemental~   + Conjure_Air_Elemental 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI532")~ +~Conjure Earth Elemental~   + Conjure_Earth_Elemental 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI522")~ +~Minor Spell Turning~   + Minor_Spell_Turning 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI523")~ +~Sunfire~   + Sunfire 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI524")~ +~Shroud of Flame~   + Shroud_of_Fire 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI525")~ +~Demi-Shadow Monsters~   + Demi_Shadow_Monsters 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI526")~ +~Summon Shadow~   + Summon_Shadow 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI533")~ +~Conjure Water Elemental~   + Conjure_Water_Elemental 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI528")~ +~Contact Other Plane~   + Contact_Other_Plane 
		++ ~Main Menu~ + main_menu
		++ ~I want to leave.~ + End
END
...
IF ~~ level_six 
	SAY ~Here is a list of available Level Six spells that you do not know.~ 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI601")~ +~Invisible Stalker~   + Invisible_Stalker 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI602")~ +~Globe of Invulnerability~   + Globe_of_Invulnerability 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI603")~ +~Tenser's Transformation~   + Tensers_Transformation 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI604")~ +~Flesh to Stone~   + Flesh_to_Stone 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI605")~ +~Death Spell~   + Death_Spell 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI606")~ +~Protection from Magic Energy~   + Protection_from_Magic_Energy 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI607")~ +~Mislead~   + Mislead 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI608")~ +~Pierce Magic~   + Pierce_Magic 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI609")~ +~True Sight~   + True_Sight 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI610")~ +~Antimagic Shell~   + Antimagic_Shell 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI611")~ +~Protection from Magical Weapons~   + Protection_from_Magical_Weapons 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI612")~ +~Power Word: Silence~   + Power_Word_Silence 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI613")~ +~Improved Haste~   + Improved_Haste 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI614")~ +~Death Fog~   + Death_Fog 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI615")~ +~Chain Lightning~   + Chain_Lightning 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI616")~ +~Disintegrate~   + Disintegrate 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI617")~ +~Contingency~   + Contingency 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI618")~ +~Spell Deflection~   + Spell_Deflection 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI619")~ +~Wyvern Call~   + Wyvern_Call 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI623")~ +~Carrion Summons~   + Carrion_Summons 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI624")~ +~Summon Nishruu~   + Summon_Nishruu 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI625")~ +~Stone to Flesh~   + Stone_to_Flesh 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI626")~ +~Lich Touch~   + Lich_Touch 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI627")~ +~Monster Summoning IV~   + Monster_Summoning_IV 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI628")~ +~Otiluke's Freezing Sphere~   + Otilukes_Freezing_Sphere 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI629")~ +~Shades~   + Shades 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI630")~ +~Darts of Bone~   + Darts_of_Bone 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI631")~ +~Soul Eater~   + Soul_Eater 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI632")~ +~Trollish Fortitude~   + Trollish_Fortitude 
		++ ~Main Menu~ + main_menu
		++ ~I want to leave.~ + End
END
...
IF ~~ level_seven 
	SAY ~Here is a list of available Level Seven spells that you do not know.~ 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI701")~ +~Spell Turning~   + Spell_Turning 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI702")~ +~Protection from the Elements~   + Protection_from_the_Elements 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI703")~ +~Project Image~   + Project_Image 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI704")~ +~Ruby Ray of Reversal~   + Ruby_Ray_of_Reversal 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI705")~ +~Khelben's Warding Whip~   + Khelbens_Warding_Whip 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI706")~ +~Monster Summoning V~   + Monster_Summoning_V 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI707")~ +~Cacofiend~   + Cacofiend 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI708")~ +~Mantle~   + Mantle 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI709")~ +~Malavon's Rage~   + Malavons_Rage 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI710")~ +~Spell Sequencer~   + Spell_Sequencer 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI712")~ +~Delayed Blast Fireball~   + Delayed_Blast_Fireball 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI713")~ +~Finger of Death~   + Finger_of_Death 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI714")~ +~Prismatic Spray~   + Prismatic_Spray 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI715")~ +~Power Word: Stun~   + Power_Word_Stun 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI716")~ +~Mordenkainen's Sword~   + Mordenkainens_Sword 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI717")~ +~Summon Efreeti~   + Summon_Efreeti 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI718")~ +~Summon Djinni~   + Summon_Djinni 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI719")~ +~Summon Hakeashar~   + Summon_Hakeashar 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI720")~ +~Control Undead~   + Control_Undead 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI721")~ +~Mass Invisibility~   + Mass_Invisibility 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI722")~ +~Limited Wish~   + Limited_Wish 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI724")~ +~Acid Storm~   + Acid_Storm 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI725")~ +~Seven Eyes~   + Seven_Eyes 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI726")~ +~Suffocate~   + Suffocate 
		++ ~Main Menu~ + main_menu
		++ ~I want to leave.~ + End
END
...
IF ~~ level_eight 
	SAY ~Here is a list of available Level Eight spells that you do not know.~ 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI801")~ +~Monster Summoning IV~   + Monster_Summoning_VI 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI802")~ +~Mind Blank~   + Mind_Blank 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI803")~ +~Protection from Energy~   + Protection_from_Energy 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI804")~ +~Simulacrum~   + Simulacrum 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI805")~ +~Pierce Shield~   + Pierce_Shield 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI806")~ +~Great Shout~   + Great_Shout 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI807")~ +~Summon Fiend~   + Summon_Fiend 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI808")~ +~Improved Mantle~   + Improved_Mantle 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI809")~ +~Spell Trigger~   + Spell_Trigger 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI810")~ +~Incendiary Cloud~   + Incendiary_Cloud 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI811")~ +~Symbol: Fear~   + Symbol_Fear 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI812")~ +~Abi-Dalzim's Horrid Wilting~   + Abi_Dalzims_Horrid_Wilting 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI813")~ +~Maze~   + Maze 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI814")~ +~Iron Body~   + Iron_Body 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI815")~ +~Power Word: Blind~   + Power_Word_Blind 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI816")~ +~Symbol: Stun~   + Symbol_Stun 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI817")~ +~Symbol: Death~   + Symbol_Death 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI818")~ +~Bigby's Clenched Fist~   + Bigbys_Clenched_Fist 
		++ ~Main Menu~ + main_menu
		++ ~I want to leave.~ + End
END
...
IF ~~ level_nine
	SAY ~Here is a list of available Level Nine spells that you do not know.~ 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI901")~ +~Monster Summoning VII~   + Monster_Summoning_VII 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI902")~ +~Spell Trap~   + Spell_Trap 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI903")~ +~Spellstrike~   + Spellstrike 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI905")~ +~Gate~   + Gate 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI907")~ +~Absolute Immunity~   + Absolute_Immunity 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI908")~ +~Chain Contigency~   + Chain_Contigency 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI909")~ +~Time Stop~   + Time_Stop 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI911")~ +~Meteor Swarm~   + Meteor_Swarm 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI912")~ +~Power Word: Kill~   + Power_Word_Kill 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI913")~ +~Wail of the Banshee~   + Wail_of_the_Banshee 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI914")~ +~Energy Drain~   + Energy_Drain 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI915")~ +~Black Blade of Disaster~   + Black_Blade_of_Disaster 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI916")~ +~Shapechange~   + Shapechange 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI917")~ +~Freedom~   + Freedom 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI918")~ +~Bigby's Crushing Hand~   + Bigbys_Crushing_Hand 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI919")~ +~Wish~   + Wish 
		++ ~Main Menu~ + main_menu
		++ ~I want to leave.~ + End
END
IF ~~ Armor 
...
This spell blinds its target. A Save vs. Spell is allowed and, if successful, there are no harmful effects. If a victim is blinded, <PRO_HESHE> receives a -4 penalty to <PRO_HISHER> attack rolls and Armor Class. Blind creatures are immune to gaze attacks. ~
	+ ~GlobalsLT("qd_sor_cur_level_2","qd_sor_spl_level_2")~ + ~Learn Blindness.~ DO ~ActionOverride(LastSummonerOf(Myself),AddSpecialAbility("SPWI226")) ActionOverride(LastSummonerOf(Myself),Rest()) IncrementGlobal("qd_sor_cur_level_1","GLOBAL",1) SmallWait(1)~ + refresh
		++ ~Return to Level Two spell options.~ + level_two
END 
IF ~~ Blur 
	SAY ~Blur 
...
This spell grants the recipient immunity to all petrification attacks. This includes basilisk and medusa gaze, cursed scrolls of petrification, etc. ~
	+ ~GlobalsLT("qd_sor_cur_level_1","qd_sor_spl_level_1")~ + ~Learn Protection from Petrification.~ DO ~ActionOverride(LastSummonerOf(Myself),AddSpecialAbility("SPWI227")) ActionOverride(LastSummonerOf(Myself),Rest()) IncrementGlobal("qd_sor_cur_level_1","GLOBAL",1) SmallWait(1)~ + refresh
		++ ~Return to Level Two spell options.~ + level_two
END 
...
When cast, this spell will cancel all Illusion/Phantasm spells of 5th level and lower within its area of effect. The spells affected are Blur, Reflected Image, Invisibility, Mirror Image, Non-Detection, Improved Invisibility, and Shadow Door. The caster can control whom this spell affects; thus, it will affect only creatures that are not in the caster's party. A target's Magic Resistance, if any, does not affect this spell.~ 
		...
		++ ~Return to Level Five spell options.~ + level_five
END 
IF ~~ Conjure_Lesser_Fire_Elemental
	SAY ~Conjure Lesser Fire Elemental
...
A wizard who casts a Conjure Lesser Fire Elemental spell summons a fire elemental to do <PRO_HISHER> bidding. The elemental has 8 Hit Dice and will serve the caster's every whim until banished back to its home plane, the spell's duration expires, or the elemental dies. However, every time this spell is cast, there is a 15% chance that the elemental will escape the instructions of the caster, go berserk, and attack the wizard who dared summoning it. If it can't reach the summoner, it will fight its way toward <PRO_HIMHER>. This berserking elemental will also remain until slain or the spell's duration expires. The elemental is locked into a psychic contest with the caster for 3 rounds after being summoned. At the end of this time, if the caster has won, <PRO_HESHE> has control of the elemental; however, if <PRO_HESHE> has lost, the elemental goes berserk and tries to kill <PRO_HIMHER>. This does not prevent the use of other charm-type spells after the contest was lost. If charm spells are used before the contest is over, they will have no effect on the outcome.~ 
		+ ~GlobalsLT("qd_sor_cur_level_5","qd_sor_spl_level_5")~ + ~Learn Conjure Lesser Fire Elemental.~ DO ~ActionOverride(LastSummonerOf(Myself),AddSpecialAbility("SPWI516")) ActionOverride(LastSummonerOf(Myself),Rest()) IncrementGlobal("qd_sor_cur_level_5","GLOBAL",1) SmallWait(1)~ + refresh
		++ ~Return to Level Five spell options.~ + level_five
END 
...
When this spell is cast, the wizard is protected from the next magical attack against <PRO_HIMHER>. The spells from which the wizard is protected are Spell Thrust, Secret Word, Breach, Lower Resistance, Pierce Magic, Ruby Ray, Warding Whip, Pierce Shield, and Spellstrike. If one of these spells is cast at the wizard, this spell activates and absorbs the attack. However, this only works once and this spell is consumed in the process. Otherwise, it will last for its duration.~ 
		...
		++ ~Return to Level Five spell options.~ + level_five
END 
IF ~~ Conjure_Lesser_Air_Elemental
	SAY ~Conjure Lesser Air Elemental
...
A wizard who casts a Conjure Lesser Air Elemental spell summons an air elemental to do <PRO_HISHER> bidding. The elemental has 8 Hit Dice and will serve the caster's every whim until banished back to its home plane, the spell's duration expires, or the elemental dies. However, every time this spell is cast, there is a 15% chance that the elemental will escape the instructions of the caster, go berserk, and attack the wizard who dared summoning it. If it can't reach the summoner, it will fight its way toward <PRO_HIMHER>. This berserking elemental will also remain until slain or the spell's duration expires. The elemental is locked into a psychic contest with the caster for 3 rounds after being summoned. At the end of this time, if the caster has won, <PRO_HESHE> has control of the elemental; however, if <PRO_HESHE> has lost, the elemental goes berserk and tries to kill <PRO_HIMHER>. This does not prevent the use of other charm-type spells after the contest was lost. If charm spells are used before the contest is over, they will have no effect on the outcome.~
		+ ~GlobalsLT("qd_sor_cur_level_5","qd_sor_spl_level_5")~ + ~Learn Conjure Lesser Air Elemental.~ DO ~ActionOverride(LastSummonerOf(Myself),AddSpecialAbility("SPWI520")) ActionOverride(LastSummonerOf(Myself),Rest()) IncrementGlobal("qd_sor_cur_level_5","GLOBAL",1) SmallWait(1)~ + refresh
		++ ~Return to Level Five spell options.~ + level_five
END 
IF ~~ Conjure_Lesser_Earth_Elemental
	SAY ~Conjure Lesser Earth Elemental
...
A wizard who casts a Conjure Lesser Earth Elemental spell summons an earth elemental to do <PRO_HISHER> bidding. The elemental has 8 Hit Dice and will serve the caster's every whim until banished back to its home plane, the spell's duration expires, or the elemental dies. However, every time this spell is cast, there is a 15% chance that the elemental will escape the instructions of the caster, go berserk, and attack the wizard who dared summoning it. If it can't reach the summoner, it will fight its way toward <PRO_HIMHER>. This berserking elemental will also remain until slain or the spell's duration expires. The elemental is locked into a psychic contest with the caster for 3 rounds after being summoned. At the end of this time, if the caster has won, <PRO_HESHE> has control of the elemental; however, if <PRO_HESHE> has lost, the elemental goes berserk and tries to kill <PRO_HIMHER>. This does not prevent the use of other charm-type spells after the contest was lost. If charm spells are used before the contest is over, they will have no effect on the outcome.~
		+ ~GlobalsLT("qd_sor_cur_level_5","qd_sor_spl_level_5")~ + ~Learn Conjure Lesser Earth Elemental.~ DO ~ActionOverride(LastSummonerOf(Myself),AddSpecialAbility("SPWI521")) ActionOverride(LastSummonerOf(Myself),Rest()) IncrementGlobal("qd_sor_cur_level_5","GLOBAL",1) SmallWait(1)~ + refresh
		++ ~Return to Level Five spell options.~ + level_five
END 
...
Upon casting a Conjure Fire Elemental spell, the caster opens a special gate to the Elemental Plane of Fire, and a fire elemental is summoned in the vicinity of the caster. There is a 60% chance that a 12-Hit-Dice elemental appears, a 35% chance that a 16-Hit-Dice elemental appears, and a 5% chance that a 24-Hit-Dice elemental appears. The elemental will do the bidding of the caster until it is slain or the duration of the spell runs out. All of the commands given to the elemental are done telepathically, so there is no time lost due to miscommunication and no need to know the language of the summoned creature. However, every time this spell is cast, there is a 15% chance that the elemental will escape the instructions of the caster, go berserk, and attack the wizard who dared summoning it. If it can't reach the summoner, it will fight its way toward <PRO_HIMHER>. This berserking elemental will also remain until slain or the spell's duration expires. The elemental is locked into a psychic contest with the caster for 3 rounds after being summoned. At the end of this time, if the caster has won, <PRO_HESHE> has control of the elemental; however, if <PRO_HESHE> has lost, the elemental goes berserk and tries to kill <PRO_HIMHER>. This does not prevent the use of other charm-type spells after the contest was lost. If charm spells are used before the contest is over, they will have no effect on the outcome.~
		+ ~GlobalsLT("qd_sor_cur_level_6","qd_sor_spl_level_6")~ + ~Learn Conjure Fire Elemental.~ DO ~ActionOverride(LastSummonerOf(Myself),AddSpecialAbility("SPWI620")) ActionOverride(LastSummonerOf(Myself),Rest()) IncrementGlobal("qd_sor_cur_level_6","GLOBAL",1) SmallWait(1)~ + refresh
		++ ~Return to Level Six spell options.~ + level_six
END 
...
Upon casting a Conjure Air Elemental spell, the caster opens a special gate to the Elemental Plane of Air, and an air elemental is summoned in the vicinity of the caster. There is a 60% chance that a 12-Hit-Dice elemental appears, a 35% chance that a 16-Hit-Dice elemental appears, and a 5% chance that a 24-Hit-Dice elemental appears. The elemental will do the bidding of the caster until it is slain or the duration of the spell runs out. All of the commands given to the elemental are done telepathically, so there is no time lost due to miscommunication and no need to know the language of the summoned creature. However, every time this spell is cast, there is a 15% chance that the elemental will escape the instructions of the caster, go berserk, and attack the wizard who dared summoning it. If it can't reach the summoner, it will fight its way toward <PRO_HIMHER>. This berserking elemental will also remain until slain or the spell's duration expires. The elemental is locked into a psychic contest with the caster for 3 rounds after being summoned. At the end of this time, if the caster has won, <PRO_HESHE> has control of the elemental; however, if <PRO_HESHE> has lost, the elemental goes berserk and tries to kill <PRO_HIMHER>. This does not prevent the use of other charm-type spells after the contest was lost. If charm spells are used before the contest is over, they will have no effect on the outcome.~
		+ ~GlobalsLT("qd_sor_cur_level_6","qd_sor_spl_level_6")~ + ~Learn Conjure Air Elemental.~ DO ~ActionOverride(LastSummonerOf(Myself),AddSpecialAbility("SPWI621")) ActionOverride(LastSummonerOf(Myself),Rest()) IncrementGlobal("qd_sor_cur_level_6","GLOBAL",1) SmallWait(1)~ + refresh
		++ ~Return to Level Six spell options.~ + level_six
END 
...
Upon casting a Conjure Earth Elemental spell, the caster opens a special gate to the Elemental Plane of Earth, and an earth elemental is summoned in the vicinity of the caster. There is a 60% chance that a 12-Hit-Dice elemental appears, a 35% chance that a 16-Hit-Dice elemental appears, and a 5% chance that a 24-Hit-Dice elemental appears. The elemental will do the bidding of the caster until it is slain or the duration of the spell runs out. All of the commands given to the elemental are done telepathically, so there is no time lost due to miscommunication and no need to know the language of the summoned creature. However, every time this spell is cast, there is a 15% chance that the elemental will escape the instructions of the caster, go berserk, and attack the wizard who dared summoning it. If it can't reach the summoner, it will fight its way toward <PRO_HIMHER>. This berserking elemental will also remain until slain or the spell's duration expires. The elemental is locked into a psychic contest with the caster for 3 rounds after being summoned. At the end of this time, if the caster has won, <PRO_HESHE> has control of the elemental; however, if <PRO_HESHE> has lost, the elemental goes berserk and tries to kill <PRO_HIMHER>. This does not prevent the use of other charm-type spells after the contest was lost. If charm spells are used before the contest is over, they will have no effect on the outcome.~
		+ ~GlobalsLT("qd_sor_cur_level_6","qd_sor_spl_level_6")~ + ~Learn Conjure Earth Elemental.~ DO ~ActionOverride(LastSummonerOf(Myself),AddSpecialAbility("SPWI622")) ActionOverride(LastSummonerOf(Myself),Rest()) IncrementGlobal("qd_sor_cur_level_6","GLOBAL",1) SmallWait(1)~ + refresh
		++ ~Return to Level Six spell options.~ + level_six
END 
IF ~~ Carrion_Summons
	SAY ~Carrion Summons
