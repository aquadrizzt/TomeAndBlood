...
IF ~TRUE()~ main_menu
	SAY ~Here are the available bloodlines for selection. ~
		++ ~Eldritch~ + eldritch
		+ ~Alignment(LastSummonerOf(Myself),MASK_GOOD) CheckStatGT(LastSummonerOf(Myself),11,INT) CheckStatGT(LastSummonerOf(Myself),11,WIS)~ + ~Celestial~ + celestial
		+ ~Alignment(LastSummonerOf(Myself),MASK_EVIL) CheckStatGT(LastSummonerOf(Myself),11,INT) CheckStatGT(LastSummonerOf(Myself),11,CON)~ + ~Fiendish~ + fiendish
		+ ~!Alignment(LastSummonerOf(Myself),MASK_LAWFUL) CheckStatGT(LastSummonerOf(Myself),11,INT) CheckStatGT(LastSummonerOf(Myself),11,DEX)~ + ~Stormborn~ + stormborn
		+ ~OR(2) Race(LastSummonerOf(Myself),HUMAN) Race(LastSummonerOf(Myself),HALF_ELF) CheckStatGT(LastSummonerOf(Myself),11,INT) CheckStatGT(LastSummonerOf(Myself),11,CON)~ + ~Rimeblooded~ + rimeblooded
		+ ~OR(2) Alignment(LastSummonerOf(Myself),MASK_GENEUTRAL) Alignment(LastSummonerOf(Myself),MASK_LCNEUTRAL) CheckStatGT(LastSummonerOf(Myself),11,INT) CheckStatGT(LastSummonerOf(Myself),11,WIS)~ + ~Groveborn~ + groveborn
		+ ~!Alignment(LastSummonerOf(Myself),MASK_LAWFUL) CheckStatGT(LastSummonerOf(Myself),11,INT) CheckStatGT(LastSummonerOf(Myself),11,CHR)~ + ~Sylvan~ + sylvan
		+ ~!Alignment(LastSummonerOf(Myself),MASK_GOOD) CheckStatGT(LastSummonerOf(Myself),11,INT) CheckStatGT(LastSummonerOf(Myself),11,STR)~ + ~Revenant~ + revenant
		+ ~!Alignment(LastSummonerOf(Myself),MASK_LAWFUL) CheckStatGT(LastSummonerOf(Myself),11,INT) CheckStatGT(LastSummonerOf(Myself),11,DEX)~ + ~Amorphous~ + amorphous
		++ ~Exit.~ + End
END
...
IF ~~ celestial 
	...
	Requires: Any good; 12 INT, 12 WIS 
...
IF ~~ fiendish 
	...
	Requires: Any evil; 12 INT, 12 CON 
...
IF ~~ stormborn 
	...
	Requires: Any non-lawful; 12 INT, 12 DEX 
...
IF ~~ rimeblooded 
	...
	Requires: Human or Half-Elf; 12 INT, 12 CON 
...
IF ~~ groveborn 
	...
	Requires: Any neutral, 12 INT, 12 WIS 
...
IF ~~ sylvan 
	...
	Requires: Any non-lawful, 12 INT, 12 CHA 
...
IF ~~ revenant 
	...
	Requires: Any non-good, 12 INT, 12 STR 
...
IF ~~ amorphous 
	...
	Requires: Human, Half-Elf or Gnome; any non-lawful, 12 INT, 12 DEX 
