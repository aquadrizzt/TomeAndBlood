...
IF ~HaveSpellRES("SPWI124")~ THEN REPLY "Nahal's Reckless Dweomer" DO ~TakePartyGold(100) DestroyGold(100) RemoveSpellRES("SPWI124") GiveItemCreate("B_SCR01",Myself,1,1,1)~ EXIT
...
IF ~HaveSpellRES("SPWI222")~ THEN REPLY "Chaos Shield" DO ~TakePartyGold(200) DestroyGold(200) RemoveSpellRES("SPWI222") GiveItemCreate("B_SCR02",Myself,1,1,1) ~ EXIT
...
IF ~HaveSpellRES("SPWI723")~ THEN REPLY "Improved Chaos Shield" DO ~TakePartyGold(1500) DestroyGold(1500) RemoveSpellRES("SPWI723") GiveItemCreate("B_SCR03",Myself,1,1,1) ~ EXIT
