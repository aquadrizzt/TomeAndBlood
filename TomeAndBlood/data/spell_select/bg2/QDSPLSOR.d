...
IF ~~ level_one 
	SAY ~Here is a list of available Level One spells that you do not know.~ 
		...
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI106")~ +~Blindness~   + Blindness 
		...
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI108")~ +~Protection from Petrification~   + Protection_from_Petrification 
...
IF ~~ level_three 
	SAY ~Here is a list of available Level Three spells that you do not know.~ 
		...
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI326")~ +~Dispel Magic~   + Dispel_Magic 
		++ ~Main Menu~ + main_menu
		++ ~I want to leave.~ + End
END
...
IF ~~ level_five 
	SAY ~Here is a list of available Level Five spells that you do not know.~ 
		...
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI516")~ +~Conjure Lesser Fire Elemental~   + Conjure_Lesser_Fire_Elemental 
		...
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI520")~ +~Conjure Lesser Air Elemental~   + Conjure_Lesser_Air_Elemental 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI521")~ +~Conjure Lesser Earth Elemental~   + Conjure_Lesser_Earth_Elemental 
...
IF ~~ level_six 
	SAY ~Here is a list of available Level Six spells that you do not know.~ 
		...
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI620")~ +~Conjure Fire Elemental~   + Conjure_Fire_Elemental 
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI621")~ +~Conjure Air Elemental~   + Conjure_Air_Elemental  
		+ ~NextTriggerObject(LastSummonerOf(Myself)) !HaveSpellRES("SPWI622")~ +~Conjure Earth Elemental~   + Conjure_Earth_Elemental  
...
This spell blinds its target. A Save vs. Spell is allowed and, if successful, there are no harmful effects. If a victim is blinded, <PRO_HESHE> receives a -4 penalty to <PRO_HISHER> attack rolls and Armor Class. Blind creatures are immune to gaze attacks. ~
	+ ~GlobalsLT("qd_sor_cur_level_1","qd_sor_spl_level_1")~ + ~Learn Blindness.~ DO ~ActionOverride(LastSummonerOf(Myself),AddSpecialAbility("SPWI106")) ActionOverride(LastSummonerOf(Myself),Rest()) IncrementGlobal("qd_sor_cur_level_1","GLOBAL",1) SmallWait(1)~ + refresh
		++ ~Return to Level Two spell options.~ + level_two
END 
IF ~~ Blur 
	SAY ~Blur 
...
This spell grants the recipient immunity to all petrification attacks. This includes basilisk and medusa gaze, cursed scrolls of petrification, etc. ~
	+ ~GlobalsLT("qd_sor_cur_level_1","qd_sor_spl_level_1")~ + ~Learn Protection from Petrification.~ DO ~ActionOverride(LastSummonerOf(Myself),AddSpecialAbility("SPWI106")) ActionOverride(LastSummonerOf(Myself),Rest()) IncrementGlobal("qd_sor_cur_level_1","GLOBAL",1) SmallWait(1)~ + refresh
		++ ~Return to Level Two spell options.~ + level_two
END 
...
Note: While this spell dispels the individual effects of Grease, Web, Stinking Cloud, and other such spells, it does not dispel the area of effect.~ 
		+ ~GlobalsLT("qd_sor_cur_level_3","qd_sor_spl_level_3")~ + ~Learn Dispel Magic.~ DO ~ActionOverride(LastSummonerOf(Myself),AddSpecialAbility("SPWI326")) ActionOverride(LastSummonerOf(Myself),Rest()) IncrementGlobal("qd_sor_cur_level_3","GLOBAL",1) SmallWait(1)~ + refresh
		++ ~Return to Level Three spell options.~ + level_three
END 
IF ~~ Hold_Undead
	SAY ~Hold Undead
